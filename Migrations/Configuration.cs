namespace BellMobiles.Migrations
{
    using BellMobiles.Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BellMobiles.Models.DataContext>
    {
        ...
        protected override void Seed(BellMobiles.Models.DataContext context)
        {
